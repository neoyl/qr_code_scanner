...
class QRView(
	...
	init {
		...
		Shared.activity?.application?.registerActivityLifecycleCallbacks(object :
	...
	override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
		when (call.method) {
			...
			"invertScan" -> setInvertScan(call.argument<Boolean>("isInvertScan")!!)
	...
	private fun startScan(arguments: List<Int>?, result: MethodChannel.Result) {
		...
		try {
			...
			result.error(e.stackTraceToString(), null, null)
		}
